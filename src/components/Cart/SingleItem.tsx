...
const SingleItem = ({ item }: { item: CartItem }) => {
  ...
  return (
    <div className="flex items-center border-t border-gray-3 px-7.5 py-5">
      ...
      <div className="min-w-[275px]">
        <div className="flex w-max items-center rounded-md border border-gray-3">
          <button
            ...
            className="flex h-11.5 w-11.5 items-center justify-center duration-200 ease-out hover:text-blue"
          >
            <svg
