...
const Header = () => {
  ...
  return (
    <header
      className={`fixed left-0 top-0 z-9999 w-full bg-white transition-all duration-300 ease-in-out ${
        stickyMenu && 'shadow'
      }`}
    >
        ...
        >
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative w-full max-w-[333px] sm:min-w-[333px]">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-[5px] border !border-l-0 border-gray-3 bg-gray-1 py-2.5 pl-4 pr-10 outline-none duration-200 ease-in"
                    />

                    <button
                      id="search-btn"
                      aria-label="Search"
                      className="absolute right-3 top-1/2 flex -translate-y-1/2 items-center justify-center duration-200 ease-in hover:text-blue"
                    >
                      <svg
          ...
          <div className="flex w-full items-center gap-7.5 lg:w-auto">
            <div className="hidden items-center gap-3.5 xl:flex">
              ...
              <div>
                <span className="block text-2xs uppercase text-dark-4">24/7 SUPPORT</span>
                <p className="text-custom-sm font-medium text-dark">(+965) 7492-3477</p>
              </div>
            </div>

            {/* <!-- divider --> */}
            <span className="hidden h-7.5 w-px bg-gray-4 xl:block"></span>
            ...
            <div className="flex w-full items-center justify-between gap-5 lg:w-auto">
              <div className="flex items-center gap-5">
                <Link href="/signin" className="flex items-center gap-2.5">
                  ...
                  <div>
                    <span className="block text-2xs uppercase text-dark-4">account</span>
                    <p className="text-custom-sm font-medium text-dark">Sign In</p>
                  </div>
                </Link>
                ...
                <button onClick={handleOpenCartModal} className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-custom-sm font-medium text-dark">${totalPrice}</p>
                  </div>
                </button>
              </div>
      ...
      <div className="border-t border-gray-3">
        <div className="mx-auto max-w-[1170px] px-4 sm:px-7.5 xl:px-0">
          <div className="flex items-center justify-between">
            {/* <!--=== Main Nav Start ===--> */}
            <div
              className={`invisible absolute right-4 top-full h-0 w-[288px] items-center justify-between xl:visible xl:static xl:flex xl:h-auto xl:w-auto ${
                navigationOpen &&
                `!visible !h-auto max-h-[400px] overflow-y-scroll rounded-md border border-gray-3 bg-white p-5 shadow-lg`
              }`}
            >
              {/* <!-- Main Nav Start --> */}
              <nav>
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      >
                        <Link
                          href={menuItem.path || ''}
                          className={`flex text-custom-sm font-medium text-dark hover:text-blue ${
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                <li className="py-4">
                  <a
                    href="#"
                    className="flex items-center gap-1.5 text-custom-sm font-medium text-dark hover:text-blue"
                  >
                    <svg
                      className="fill-current"
                      width="16"
