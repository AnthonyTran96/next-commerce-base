...
const SingleListItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group rounded-lg bg-white shadow-1">
      <div className="flex">
        <div className="relative flex w-full max-w-[270px] items-center justify-center overflow-hidden p-4 shadow-list sm:min-h-[270px]">
        ...
        <div className="flex w-full flex-col justify-center gap-5 px-4 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-7.5 lg:pl-11 lg:pr-12">
          <div>
